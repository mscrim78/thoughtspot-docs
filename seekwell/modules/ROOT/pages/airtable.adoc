...
. Add your Airtable API key to the source and click *Save*.
+
...
. Go to link:https://airtable.com/api[https://airtable.com/api,window=_blank] and click on the base you want to connect to. Check the URL for the Base / App ID, it should start with "app". The ID also appears in green on this page in third paragraph.
+
