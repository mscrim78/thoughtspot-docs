...
. Click kbd:[`command`] / kbd:[`control`] + kbd:[`k`], then search for *Explore Sets*.
...
. Click kbd:[`command`] + kbd:[`enter`], or select the *Run* icon to see your results. {seekwell} displays your results as a table by default. To see your results as a chart, click the *chart* icon.
