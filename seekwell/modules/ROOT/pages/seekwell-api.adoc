...
.  Open the link:https://app.seekwell.io/[web app,window=_blank] and hit kbd:[`command`] / kbd:[`control`] + kbd:[`k`], then type “API”. Click *Create API key* to generate an API key.
