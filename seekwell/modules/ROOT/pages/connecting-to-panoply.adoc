...
To connect to link:https://panoply.io/[Panoply] from SeekWell:
...
. To find the remaining connection information, navigate to Panoplu and click *BI Connection* in the Panoply nav. A window similar to the following image appears, where you can find the *Database*, *User*, *Password*, and *Driver* information.
+
