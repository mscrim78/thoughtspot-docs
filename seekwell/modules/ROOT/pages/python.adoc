...
. To begin, link:https://app.seekwell.io/[open the app] and hit `command` / `control` + `k`, and entering "python".
...
Create a new block named "SuperBowl" and add the script below. Hit `command` / `control` + `k`, enter "Python", and run the block.
