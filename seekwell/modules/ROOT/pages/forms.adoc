...
. To view the block as a form, hit `command` / `control` + `k` and search for "Go to Form".
...
Hit `command` / `control` + `k`, and search for "Forms" to see a list of all your Forms and quickly access one.
