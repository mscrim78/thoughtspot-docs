...
The 10.6.0.sw release of ThoughtSpot Software, targeted for October 2024 (GA), will drop support for the following feature:

Search Assist:: Located on the Data Workspace page.
