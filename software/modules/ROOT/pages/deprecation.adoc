...
Search Assist:: ThoughtSpot will remove the Search Assist feature from the Data Workspace page.

[#deprecated-10-1-0-sw]
...
Search Assist:: ThoughtSpot will no longer support the Search Assist feature on the Data Workspace page, and plans to remove it in a future release. Until it is removed, you can still use it.
...
+
Instead, starting in the 8.4.0.sw [LA] release, if you are embedding through https://developers.thoughtspot.com/[ThoughtSpot Embedded^], you can create new custom actions in the Develop tab. Refer to https://developers.thoughtspot.com/docs/?pageid=customize-actions#_custom_actions_page[Custom actions overview^].
