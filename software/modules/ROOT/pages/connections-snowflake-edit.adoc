...
:jira: SCAL-118895, SCAL-201045, SCAL-136317 (multiple confiurations for snowflake)
...
+
TIP: To edit the *Default* configuration of your {connection} connection, see xref:connections-snowflake-edit.adoc[].

include::partial$connection-disable-additional-config.adoc[]

include::partial$connection-delete-additional-config.adoc[]

For information about how to create additional configurations for your {connection} connection, see xref:connections-snowflake-add.adoc#additional-configurations-create[Creating additional configurations for your {connection} connection]
