...
. *Change the admin password* Refer to xref:launch-an-instance-azure.adoc#prepare-for-startup[Prepare for starting up ThoughtSpot] to learn how to log in to your VM with the private key, and change the admin password.
