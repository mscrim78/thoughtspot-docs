...
The ThoughtSpot Virtual Machine has the ThoughtSpot software installed and configured.
...
This guide explains how to deploy ThoughtSpot on Microsoft Azure on Red Hat Enterprise Linux (RHEL), allowing you to run ThoughtSpot on an RHEL 7.8, 7.9, 8.1, 8.2, 8.3, 8.4, 8.5, 8.6, 8.7, or 8.8 image that your organization manages internally.
