...
|SCAL-199453
|Scheduled Liveboards do not include all visualizations when using csv format.
a|*Symptoms*:

Only the CSV of the first visualization is sent in the email. All other CSVs are missing from the email.


*Conditions*:

Liveboard with multiple visualizations and configured schedule.
