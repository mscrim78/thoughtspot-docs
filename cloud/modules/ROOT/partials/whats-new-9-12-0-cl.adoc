...
[discrete]
=== GIT integration for version control [.badge.badge-early-access]#Early Access#
endif::[]
ifdef::pendo-links[]
[#9-12-0-cl-first-last]
[discrete]
=== GIT integration for version control [.badge.badge-early-access-whats-new]#Early Access#
endif::[]
// Mark – doc jira: SCAL-196890
// PM: Nico

Now teams of analysts can more easily collaborate on content development of Liveboards and Answers. When your ThoughtSpot administrator enables version control on your ThoughtSpot cluster,  you can enable version control on specific Liveboards and Answers. With version control enabled, every time you save the Liveboard or Answer, a new version is created and stored in Github. You can browse the version history in ThoughtSpot and restore any saved versions whenever you need to.
