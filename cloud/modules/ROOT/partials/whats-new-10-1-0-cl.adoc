...
[#10-1-0-cl-orgs]
[discrete]
=== Per Orgs URLs [.badge.badge-beta]#Beta#
ThoughtSpot introduces Org specific URLs. With per Org URLs, the UI will maintain the Org that the user is logged into. When a user switches Orgs using the Org switcher, they are directed to the subdomain of the new Org.
