...
Bridge provides options to securely connect your data source with the ThoughtSpot Cloud, as a alternative to PrivateLink, VPC Peering or VPN tunnels. We support Bridge for the following Connectors:
