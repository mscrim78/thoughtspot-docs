...
* A banner appears when you edit an Answer on, or pin an Answer to, a verified Liveboard, warning that making any modification will change the "Verified" banner to one that advises the Liveboard has been modified and may need to be verified again.
