...
[#9-6-0-cl-metadata]
[discrete]
=== Alation metadata [.badge.badge-beta]#Beta#
endif::[]
ifdef::pendo-links[]
[#9-6-0-cl-metadata]
[discrete]
=== Alation metadata [.badge.badge-beta-whats-new]#Beta#
endif::[]
...
You can now hide a column from your table without removing it from your current Search. If you hide the column you're using to sort results, the sorting order is unchanged. To try it out, create an Answer, open the chart configuration menu image:icon-gear-10px.png[gear icon], and drag the selected column to *Hidden Columns*. For more information, see
ifndef::pendo-links[]
xref:chart-table.adoc#hidden-column[Hidden columns].
endif::[]
ifdef::pendo-links[]
xref:chart-table.adoc#hidden-column[Hidden columns,window=_blank].
endif::[]
...
[#9-6-0-cl-alation]
[discrete]
=== Alation catalog integration [.badge.badge-beta]#Beta#
endif::[]
ifdef::pendo-links[]
[#9-6-0-cl-alation]
[discrete]
=== Alation catalog integration [.badge.badge-beta-whats-new]#Beta#
endif::[]
