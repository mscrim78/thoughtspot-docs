...
ifndef::pendo-links[]
xref:ai-answers.adoc#sage-coach[Give feedback to AI-generated Answers].
endif::[]
ifdef::pendo-links[]
xref:ai-answers.adoc#sage-coach[Give feedback to AI-generated Answers,window=_blank].
endif::[]
...
For more information about how to configure a custom sort order, see
xref:worksheet-custom-sort.adoc[Define a custom sort order for a Worksheet].

For more information about how to use custom sorting, see
xref:chart-table-change.adoc#custom-sort[Custom Sort].
// Mary - SCAL-156895
