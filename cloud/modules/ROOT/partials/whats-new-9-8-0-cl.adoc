ifndef::pendo-links[]
January 2023 [label label-dep]#9.8.0.cl#
endif::[]
ifdef::pendo-links[]
...
In this release, custom calendar is now enabled by default for connections which support custom calendar. For details, see xref:connections-cust-cal.adoc[Custom calendar overview].
