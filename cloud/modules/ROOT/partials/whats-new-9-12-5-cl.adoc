...
ThoughtSpot introduces the ability to save table layouts on the schema editor. Table location and size are now maintained and saved in the schema editor.
