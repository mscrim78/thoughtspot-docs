...
ifndef::pendo-links[]
xref:thoughtspot-homepage.adoc[New home page].
endif::[]
ifdef::pendo-links[]
xref:thoughtspot-homepage.adoc[New home page,window=_blank].
endif::[]
...
This new navigation experience is disabled by default. Contact your ThoughtSpot administrator to enable this feature for your cluster. After that, open your user profile, and in the _Experience_ section, set the _Navigation and Homepage_ to *New experience*. Note that this setting also enables the redesigned home page. For more information, see
ifndef::pendo-links[]
