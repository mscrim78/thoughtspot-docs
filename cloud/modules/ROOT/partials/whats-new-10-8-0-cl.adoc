...
[discrete]
=== Column name and description localization and aliasing [.badge.badge-beta]#Beta#
endif::[]
ifdef::pendo-links[]
[#10-7-0-cl-data-modeling]
[discrete]
=== Column name and description localization and aliasing [.badge.badge-beta-whats-new]#Beta#
endif::[]

This feature provides the ability to define a column name or description alias based upon a language variable, the user's system language. Based on the system language selected in a user's profile, the appropriate localized column name or description is displayed in the search data and Answer interface. To enable this feature, contact {support-url}.
