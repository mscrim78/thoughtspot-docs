...
[discrete]
=== Admin > Early access features page update

The Admin > Early access features page has been redesigned to allow an administrator to select multiple early access features and enable them all at the same time.
