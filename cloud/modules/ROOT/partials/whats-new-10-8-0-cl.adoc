...
We are gradually making this available to customers, so if you don't see it immediately after your instance is upgraded, it should appear within one month.
...
// PM: Reshma. simplify and shorten. Is this a sync between IdPs and ThoughtSpot? Shorten first sentence and keep last two sentences.
