...
[#9-5-0-cl-spotapp]
[discrete]
=== Fivetran SpotApp connector block

// Mark

In this release, the Fivetran SpotApp connector block is GA. Fivetran helps you move data from applications like Salesforce, ServiceNow, Jira and others into a cloud data warehouse so you can use the SpotApps designed for those applications.

See
ifndef::pendo-links[]
xref:spotapps-fivetran.adoc[Fivetran SpotApp connector block].
endif::[]
ifdef::pendo-links[]
xref:spotapps-servicenow.adoc[Fivetran SpotApp connector block,window=_blank].
endif::[]
