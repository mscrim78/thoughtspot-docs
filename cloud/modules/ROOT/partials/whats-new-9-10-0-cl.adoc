...
image::ai-highlights-window.png[Personalized columns]
...
Previously ThoughtSpot supported either group sync or org sync but not both together. You can now sync both group and org together. You can sync users that are part of given groups in given orgs from the SAML response.
...
//[discrete]
//=== IAM v2 - OIDC support
//Awaiting information from Aashica & access to Eng doc.
// Mary -- scal-119837
