...
AI highlights provides you with quick insights on how top metrics changed in your Liveboard, helping you to focus on the changes that are most important to you. Just open your Liveboard, and click the AI highlights button image:ai-highlights.png[AI highlights]. ThoughtSpot generates a summary of the changes in your KPIs. When the highlights are ready, click *View AI Highlights*.
...
You can now add your own custom charts to ThoughtSpot. For more information about using custom charts, see xref:chart-byoc.adoc[Custom charts]. For developers who want to create custom charts, refer to the link:https://github.com/thoughtspot/ts-chart-sdk/blob/main/README.md/[ThoughtSpot charts SDK documentation^].
