...
You can now add your own custom charts to ThoughtSpot.

For more information about using custom charts, see
ifndef::pendo-links[]
...
For developers who want to create custom charts, see
ifndef::pendo-links[]
link:https://github.com/thoughtspot/ts-chart-sdk/blob/main/README.md/[ThoughtSpot charts SDK documentation^].
endif::[]
ifdef::pendo-links[]
link:https://github.com/thoughtspot/ts-chart-sdk/blob/main/README.md/[ThoughtSpot charts SDK documentation^].
endif::[]
