...
You can now add your own custom charts to ThoughtSpot. For developers who want to create custom charts, refer to the https://github.com/thoughtspot/ts-chart-sdk/blob/main/README.md/[ThoughtSpot charts SDK documentation^].
