...
ThoughtSpot Cloud 9.7.0.cl is now available.
...
Alation catalog integration [.badge.badge-beta-relnotes]#Beta#::
...
For more information, see xref:rbac.adoc[Understand RBAC and privileges].
