...
:jira: SCAL-91104, SCAL-196178, SCAL-136317 (multiple confiurations for snowflake), SCAL-248181
...
NOTE: Service accounts using Username/Password must be set in Snowflake as a "LEGACY_SERVICE" account, and must be moved over to Key Pair authentication by November 2025, per link:https://www.snowflake.com/en/blog/blocking-single-factor-password-authentification/[Snowflake].
