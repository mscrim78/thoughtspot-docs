...
:page-aliases: customSorting.adoc
 ...
 ** *Custom Sort* attributes to sort charts in a way that helps users to consume them more efficiently. Sort on any attribute in a chart, using the *Custom Sort* column. Enter the attributes in your desired sort order. To enable this feature, contact your administrator.
