...
:jira: SCAL-157885, SCAL-157886, SCAL-157887, SCAL-157890, SCAL-157889
...
+
NOTE: ThoughtSpot auto-selects objects created in previous syncs when you go through the sync process again.
