...
If there are any changes to the dbt models that you would like the ThoughtSpot Worksheets and tables to reflect, you must edit the dbt sync you created. This updates the existing Worksheets and tables.
...
. Run the dbt sync again, making any changes you would like. Follow the steps in <<integrate,Integrating with dbt>>. This updates your Worksheets and tables based on the changes in your dbt models.
+
