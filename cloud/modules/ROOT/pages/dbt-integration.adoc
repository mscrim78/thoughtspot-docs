...
:jira: SCAL-157885, SCAL-157886, SCAL-157887, SCAL-157890, SCAL-157889, SCAL-119947, SCAL-182271, SCAL-182987, SCAL-186187, SCAL-132886
...
[#prerequisites]
== Prerequisites
Before you can sync with dbt, you must satisfy the following prerequisites
...
You can set up your dbt sync from the Data workspace. To sync with dbt, follow these steps:
...
. If you receive the following error, you may need to switch to an older version of dbt. ThoughtSpot supports dbt for versions 1.6 and earlier. Navigate to dbt and go to *Deploy > Environments > Environment_Name > Settings*. Click the dbt Version menu and scroll down to select 1.6.
+
----
