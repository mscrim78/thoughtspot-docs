...
For information about how to embed ThoughtSpot in your app, see https://developers.thoughtspot.com/docs/js-reference#_visual_embed_sdk_libraries[Visual Embed SDK,window=_blank].
