...
:jira: SCAL-198582, SCAL-202496, SCAL-220961, SCAL-220962
...
The 10.10.0.cl release of ThoughtSpot Cloud, targeted for the second half of 2025 (GA), removes the following feature from the *Data workspace*:
...
The 10.4.0.cl release of ThoughtSpot Cloud, targeted for November 2024 (GA), removes the following feature from the *Data workspace*:
...
The 10.4.0.cl release of ThoughtSpot Cloud, targeted for November 2024 (GA), deprecates the following feature from the *Data workspace*:
...
The 10.3.0.cl release of ThoughtSpot Cloud, targeted for October 2024 (GA), deprecates the following feature. You can still use these features, but ThoughtSpot will remove these features in a later release.

- Sage Feedback Leaderboard

== Deprecated in 10.1.0.cl

The 10.1.0.cl release of ThoughtSpot Cloud, targeted for August 2024 (GA), deprecates the following features in the *Data workspace*. You can still use these features, but ThoughtSpot will remove these features in a later release.
...
The 10.1.0.cl release of ThoughtSpot Cloud, targeted for August 2024 (GA), removes the following features:
