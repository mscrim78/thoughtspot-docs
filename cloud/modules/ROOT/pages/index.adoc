  ...
  <div class="box">
    ...
    <ul>
      ...
      <li><a href="https://docs.thoughtspot.com/cloud/latest/search-data">Search Data</a></li>
        ...
        <li><a href="https://docs.thoughtspot.com/cloud/latest/liveboard-ai-highlights">AI Highlights</a></li>
...
<li><a href="https://docs.thoughtspot.com/cloud/latest/thoughtspot-sheets">Add-on for Google Sheets&trade;</a></li>
<li><a href="https://docs.thoughtspot.com/cloud/latest/thoughtspot-slides">Add-on for Google Slides&trade;</a></li>
  ...
  <div class="box">
    ...
    <ul>
      ...
      <li><a href="https://docs.thoughtspot.com/cloud/latest/models">Create Models</a></li>
