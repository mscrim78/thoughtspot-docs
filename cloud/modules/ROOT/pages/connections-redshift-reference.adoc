...
Host:: Enter the host name associated with the database. If you used an xref:connections-redshift-private-link.adoc[AWS PrivateLink between your Redshift data warehouse and the ThoughtSpot Cloud tenant], use the PrivateLink Endpoint DNS name provided by {support-url}, and append the database host name.
