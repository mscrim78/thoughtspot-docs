...
NOTE: "of" and "percentage of" keywords are in beta, and off by default. If they are not available on your cluster, you must contact {support-url} to enable them.
