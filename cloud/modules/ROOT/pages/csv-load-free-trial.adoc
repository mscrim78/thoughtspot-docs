...
In ThoughtSpot's free trial, you can upload your own data to perform live queries on it. You can xref:connections.adoc[connect to your cloud data warehouse], and you can upload 10 flat data files, or CSV files.
